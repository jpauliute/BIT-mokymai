...
const Calculator = () => {
  ...
  const handleDigits = (e) => {
    if (!action) {
      ...
      if (second === "0" || typeof result !== "undefined") return;
  ...
  const Buttons = () => {
    ...
    for (let i = 9; i >= 0; i--) {
      result[result.length] = (
        <Button key={i} click={handleDigits} content={i} />
      );
    }
    ...
    <>
      <div className="calculator">
        ...
        <div className="actions mt-2">
          <Button style="warning" content="+" click={handleAction} />
          <Button style="warning" content="-" click={handleAction} />
          <Button style="warning" content="*" click={handleAction} />
          <Button style="warning" content="/" click={handleAction} />
          <Button style="primary" content="=" click={handleResult} />
          <Button style="danger" content="C" click={handleClear} />
        </div>
      </div>
